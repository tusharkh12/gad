...
public class DynamicStackTest {
    ...
    void artemisTest() throws NoSuchFieldException, IllegalAccessException {
        ...
        assertEquals(2, ds.popBack());
        checkStack(ds, new int[]{1, 0, 0}, "Stack should shrink and only copy the needed elements");

        assertEquals(1, ds.popBack());
        checkStack(ds, new int[]{}, "Stack should shrink and only copy the needed elements");
